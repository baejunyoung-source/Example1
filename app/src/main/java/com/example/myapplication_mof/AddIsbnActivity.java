...
public class AddIsbnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnBookSearch).setOnClickListener(v ->
                Toast.makeText(this, "도서 검색 결과를 표시했습니다.", Toast.LENGTH_SHORT).show());
